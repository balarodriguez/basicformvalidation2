...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        this.userModel = new _user__WEBPACK_IMPORTED_MODULE_2__["User"]('', "rob@gmail.com", 9629044576, "", "morning", true);
    }
    AppComponent.prototype.validateCourse = function (value) {
        if (value === 'default') {
            this.topicHasError = true;
        }
        else {
...
var User = /** @class */ (function () {
    function User(name, email, phone, course, timePreferences, offer) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.course = course;
...
module.exports = __webpack_require__(/*! E:\Angular Forms\tdf\src\main.ts */"./src/main.ts");
